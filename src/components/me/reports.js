...
const MeReports = () => {
  ...
  const { lookupReport, lookupByLevel, lookupByNickname, lookupByLogin, updateUserData } = useApi();
                ...
                {lookupReportData.map((rec, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <span
                        className="nickname-hover"
                        onClick={() => lookupByLogin(rec.login)}
                      >
                        {rec.login}
                      </span>
                    </td>}
                    {lookupReportColumns.nickname && (<td>
                      <span
                        className="nickname-hover"
                        onClick={() => lookupByNickname(rec.nickname)}
                      >
                        {rec.nickname}
                      </span>
                    </td>)}
                    {lookupReportColumns.level && (<td>
                      <span
                        className="nickname-hover"
                        onClick={() => lookupByLevel(rec.level)}
                      >
                        {rec.level}
                      </span>
                    </td>)}
                    ...
                    <td>
                      <span
                        className="nickname-hover"
                        onClick={() => lookupByLogin(rec.reportLogin)}
                      >
                        {rec.reportLogin}
                      </span>
                    </td>}
                    <td>
                      <span
                        className="nickname-hover"
                        onClick={() => lookupByNickname(rec.reportNickname)}
                      >
                        {rec.reportNickname}
                      </span>
                    </td>
                    <td>
                      <span
                        className="nickname-hover"
                        onClick={() => lookupByLevel(rec.reportLevel)}
                      >
                        {rec.reportLevel}
                      </span>
                    </td>
...
const SingleReportTable = ({ rec, isAdmin, isDeputy, isMe }) => {
  const { lookupByLevel, lookupByNickname, lookupByLogin } = useApi(); 
