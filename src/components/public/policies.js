...
<p>
    ...
    <ul>
        ...
        <li>Who have you usually played with with those other accounts?</li>
    </ul>
</p>
<p>
...
<div style={{ height: '10px' }}></div>
<h2 id="policySharing"> Account Sharing </h2>
...
<p>
    ...
    If more than one person have contributed XPs to an account, than that
    account is shared.
...
<div style={{ height: '10px' }}></div>
      ...
      <h2 id="policy2">Account Merging</h2>
      <p>
      ...
      <p>
        This is an experimental Merge Account calculator. You can enter in the XP or level of each of the accounts
...
<p>
    ...
    also be good. If you miss your queues and your get a BE_POLITE nickname warning from the
...
<div style={{ height: '10px' }}></div>
<h2 id="policyNews"> News Posting </h2>
<p>
    If you are interested in being a News corespondent, please contact sasafrass on Discord
